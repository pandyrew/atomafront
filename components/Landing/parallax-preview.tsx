      ...
      <div className="sticky top-0 h-screen overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 py-24 flex items-center justify-between">
          <div className="relative w-2/3 h-[600px] perspective-1000">
            <div className="absolute -left-20 top-20 w-40 h-40 bg-blue-500/10 rounded-full blur-3xl animate-pulse-slow" />
            <div className="absolute -right-10 bottom-20 w-60 h-60 bg-purple-500/10 rounded-full blur-3xl animate-pulse-slow animation-delay-2000" />

            {features.map((feature, index) => (
              <div
                key={index}
                className="absolute left-1/2 top-3/4 w-[400px] transition-all duration-300 rounded-full"
                style={getFeatureStyles(index)}
              >
                <div
                  className={`
                  relative rounded-[10px]
                  ${index === activeIndex ? "glow-effect-dark" : ""}
                `}
                >
                  <Image
                    src={feature.image}
                    ...
                    width={500}
                    height={300}
                    className="shadow-2xl rounded-[10px] border border-white/10 backdrop-blur-sm"
                  />
                </div>
              </div>
            ))}
          ...
          <div className="w-1/3 relative">
            <div className="absolute -left-10 top-0 w-20 h-20 border border-white/10 rounded-lg rotate-12 animate-float" />
            <div className="absolute right-0 bottom-20 w-16 h-16 border border-white/10 rounded-full animate-float animation-delay-1000" />
            ...
            <div className="transition-all duration-500 relative z-10">
              ...
              `}
              >
                <h2 className="text-4xl mb-6 font-outfit text-white">
